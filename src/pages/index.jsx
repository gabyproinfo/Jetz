...
export default function HomePage() {
  ...
  */
  ...
  const PedidosMarkup = Pedidos?.length ? (
  ...
  /*  const prueba= (<DisplayText>{'Debes crear el token de acceso. ¿Como?  Presiona click en el link o dirigete a la pestaña token de acceso.'}</DisplayText>) */
  const pageInicio = (
    <Layout>
      <Layout.Section>
        <Card title="" sectioned>
          {
            <MediaCard
              ...
              description=" Debes crear el token de acceso. ¿Como?  Presiona click en el link o dirigete a la pestaña token de acceso."
            ...
            >
              <img
                ...
                src="https://jetz.mx/images/assets/2021/main_logo.svg"
              />
  ...
  const pageAyuda = (
    <Layout>
      <Layout.Section>
        ...
        <Card title="">
          <DisplayText size="small" spacing="tight"></DisplayText>
          <CalloutCard
